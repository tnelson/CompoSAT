...
import edu.mit.csail.sdg.alloy4whole.TestUI;
import edu.mit.csail.sdg.alloy4whole.TupleInExpr;
...
public class Evaluation {
    ...
    private static long eval(PrintWriter writer, TestUI amalgam, String spec, int modelNum, MemoryStopwatch modelMSW, boolean pos) throws Exception {
        long exceptionCount = 0;
        Set<TupleInExpr> toTest = amalgam.getTestableTuples(pos);
    ...
    private static class Data {
        ...
        final String info;
        // Constructor
        Data(String spec, Integer modelNum, MemoryStopwatch modelmsw, Boolean pos, TupleInExpr test, boolean pass, MemoryStopwatch askmsw, List<ProvenanceTree> provs, String info) {
            // set data
            this.spec = spec;
