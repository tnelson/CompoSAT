...
public class CoverageStruct {
    final public Coverage coverage;
    ...
    public CoverageStruct(Coverage coverage, Context ctx, Optimize solver, 
    ...
    public Queue<CoverageModel> getQueue() {
        ...
        //Coverage.printAllProv(realTraces);
        ...
        coverage.timeLogger.popTime("solving");
        ctx.close();
